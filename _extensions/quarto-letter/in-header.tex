...
% --- per-document font handling (add this at top of in-header.tex) ---
$if(font)$
  \usepackage{iftex}
  \ifPDFTeX
    % fallback for pdfLaTeX: use a Times-like package
    \usepackage{mathptmx}
  \else
    % XeTeX or LuaTeX -> use fontspec for system fonts
    \usepackage{fontspec}
    \setmainfont{$font$}
